...
// layer 0 Mac
[0] = LAYOUT_96_ansi(
   KC_ESC,    KC_BRID,   KC_BRIU,   MAC_TASK,    MAC_SEARCH,   MAC_VOICE, MAC_DND,   KC_MPRV,     KC_MPLY,   KC_MNXT,    KC_MUTE,    KC_VOLD,    KC_VOLU,     LSG(KC_4),  KC_DEL,    KC_HOME,   KC_END,    KC_PGUP,   KC_PGDN,
...
[1] = LAYOUT_96_ansi(
   ...
   RM_TOGG,      RM_NEXT,   RM_VALU,   RM_SPDU,     RM_HUEU,      RM_SATU,   SIDE_MOD,  SIDE_VAI,    SIDE_SPI,  _______,    _______,    DEV_RESET,  SLEEP_MODE,  BAT_SHOW,              _______,   _______,   _______,   _______,
   _______,      RM_PREV,   RM_VALD,   RM_SPDD,     RM_HUED,      RM_SATD,   SIDE_HUI,  SIDE_VAD,    SIDE_SPD,  _______,    _______,    _______,    NK_TOGG,                            _______,   _______,   _______,
   _______,                 _______,   _______,     _______,      _______,   _______,   _______,     _______,   _______,    _______,    _______,    _______,                _______,    _______,   _______,   _______,   _______,
   MOUSE_JIGGLE, _______,   WIN_LOCK,                             RGB_TEST,                                                 _______,    _______,    _______,     _______,   _______,    _______,   _______,   _______),
// layer 2 win
[2] = LAYOUT_96_ansi(
...
// layer 3 win Fn
[3] = LAYOUT_96_ansi(
   _______,      KC_BRID,   KC_BRIU,   _______,     _______,      _______,   _______,   KC_MPRV,     KC_MPLY,   KC_MNXT,    KC_MUTE,    KC_VOLD,    KC_VOLU,     _______,   KC_INS,      _______,  _______,   _______,   _______,
   _______,      LNK_BLE1,  LNK_BLE2,  LNK_BLE3,    LNK_RF,       _______,   _______,   _______,     _______,   _______,    _______,    _______,    _______,     _______,                _______,  _______,   _______,   _______,
   RM_TOGG,      RM_NEXT,   RM_VALU,   RM_SPDU,     RM_HUEU,      RM_SATU,   SIDE_MOD,  SIDE_VAI,    SIDE_SPI,  _______,    _______,    DEV_RESET,  SLEEP_MODE,  BAT_SHOW,              _______,   _______,   _______,   _______,
   _______,      RM_PREV,   RM_VALD,   RM_SPDD,     RM_HUED,      RM_SATD,   SIDE_HUI,  SIDE_VAD,    SIDE_SPD,  _______,    _______,    _______,    NK_TOGG,                            _______,   _______,   _______,
   _______,                 _______,   _______,     _______,      _______,   _______,   _______,     _______,   _______,    _______,    _______,    _______,                _______,    _______,   _______,   _______,   _______,
